...
urlpatterns = [
    ...
    # path('users/<int:page>/', adminapp.users, name='users'),
    path('users/<int:page>/', adminapp.UsersListView.as_view(), name='users'),
    ...
    path('categories/<int:page>/', adminapp.categories, name='categories'),
    ...
    path('products/read/category/<int:pk>/<int:page>/', adminapp.products, name='products'),
